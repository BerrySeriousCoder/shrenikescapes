...
export default function WeddingsHub() {
  ...
  return (
    <div className="relative w-full h-screen bg-[var(--color-brand-cream)] font-sans">
      ...
      <div className="absolute top-20 md:top-12 left-0 right-0 z-40 text-center pointer-events-none px-4">
         <h1 className="text-3xl md:text-5xl font-bold text-white drop-shadow-xl tracking-widest uppercase">The Celebration</h1>
      </div>

      {/* Mobile: vertical split screen */}
      <div className="flex flex-col md:hidden w-full h-full">
        {/* International card */}
        <Link href="/weddings/international" className="flex-1 w-full relative">
          <Image 
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
            ...
            <span className="inline-block bg-[#F7F0DE] text-[#215D2D] px-6 py-2 rounded-full font-bold shadow-2xl">
              Global Romance
            </span>
          </div>
        </Link>
        ...
        {/* Domestic card */}
        <Link href="/weddings/domestic" className="flex-1 w-full relative">
          <Image 
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
            ...
            <span className="inline-block bg-[#F3C10A] text-[#215D2D] px-6 py-2 rounded-full font-bold shadow-2xl">
              Royal Heritage
            </span>
          </div>
        </Link>
