                ...
                <div className="relative z-10 w-full h-full p-8 md:p-14 flex flex-col justify-between">
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between w-full">
                    ...
                    <div className="mt-8 md:mt-0 flex items-center gap-6">
                      ...
                      {/* FAB Icon */}
                      <div className="w-16 h-16 rounded-full bg-[var(--color-brand-cream)] flex items-center justify-center text-[var(--color-brand-green)] transform transition-transform duration-500 group-hover:rotate-45 group-hover:bg-[var(--color-brand-blue)] group-hover:text-white">
