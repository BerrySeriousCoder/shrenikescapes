...
import itinerariesData from "../../../../lib/data/international_itineraries.json";
import { use } from "react";

export default function InternationalTourDetail({ params }: { params: Promise<{ id: string }> }) {
  const resolvedParams = use(params);
  const tour = tours.find((t: Tour) => t.id === resolvedParams.id && t.region === "international");
