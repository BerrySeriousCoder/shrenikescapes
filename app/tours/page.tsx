...
export default function ToursHub() {
  ...
  return (
    <div className="flex w-full h-screen overflow-hidden bg-[var(--color-brand-cream)]">
      
      {/* Absolute Header Overlay (since Navbar is used globally, we might just use that, but here's a specific close/back button if needed) */}
      ...
      <div className="absolute top-12 left-0 right-0 z-40 text-center pointer-events-none">
         <h1 className="text-4xl md:text-5xl font-bold text-white drop-shadow-xl tracking-widest uppercase">Where to?</h1>
      </div>
