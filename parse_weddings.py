...
base_dir = "../Website Material/Destination Wedding Itineraries"
itineraries = {}
...
for region in ['Domestic', 'International']:
    ...
    for file in os.listdir(region_path):
        if not file.endswith('.docx') or file.startswith('~'): continue
...
with open("lib/data/wedding_itineraries.json", "w", encoding="utf-8") as f:
    json.dump(itineraries, f, indent=2, ensure_ascii=False)

print(f"Generated lib/data/wedding_itineraries.json with {len(itineraries)} weddings.")
